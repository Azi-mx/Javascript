            ...
            for (let i = 0; i < data.ProDetails.length; i++) {
                if (uid == data.ProDetails[i].pid) {
                    ...
                    if (path != '') {
                        ...
                        data.ProDetails[i].PImg = JSON.parse(localStorage.getItem("ProductImage"));
                    }
                }
    ...
    if (data != null && data.ProDetails.length > 0) {
        ...
        for (let i = 0; i < data.ProDetails.length; i++) {
            ...
            <tr>
                    ...
                    <td><input type='button' class="btn btn-warning" value='Edit' onclick='EditData(${data.ProDetails[i].pid})'>
                    <input type='button' class="btn btn-danger" value='Delete' onclick='delData(${data.ProDetails[i].pid})'></td>
                    </tr>
                    <tbody>`
        }
